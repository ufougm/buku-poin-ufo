...
export const ACTIVITY_TYPES = [
  ...
  { id: 2, name: "Pameris UTOPIA", category: "Pameran", points: 15, description: "Pameris dalam pameran UTOPIA" },
  { id: 3, name: "Pameris Pameran Prapel", category: "Pameran", points: 10, description: "Pameris dalam pameran prapel" },
  { id: 4, name: "Panitia Pameran Prapel", category: "Pameran", points: 10, description: "Panitia dalam pameran prapel" },
  { id: 5, name: "Memenangkan Lomba Fotografi/Videografi diluar UGM (S&K Berlaku)", category: "Prestasi", points: 8, description: "Juara lomba foto/video eksternal" },
  { id: 6, name: "Diklat Wajib & Umum", category: "Diklat", points: 8, description: "Kegiatan diklat wajib dan umum" },
  { id: 7, name: "Event Hunting UFO", category: "Hunting", points: 8, description: "Kegiatan event hunting UFO" },
  { id: 8, name: "Kunjungan Pameran UTOPIA", category: "Pameran", points: 8, description: "Kunjungan ke pameran UTOPIA" },
  { id: 9, name: "Berpartisipasi Dalam Kegiatan HUT UFO", category: "Event", points: 5, description: "Partisipasi kegiatan HUT UFO" },
  { id: 10, name: "Hunting Bareng Ufo/Cufo Diluar Event Hunting (Min. 3 Orang)", category: "Hunting", points: 5, description: "Hunting bersama anggota minimal 3 orang" },
  { id: 11, name: "Ketua Kelas Pameran Pra Pelantikan", category: "Pameran", points: 5, description: "Ketua kelas dalam pameran pra-pelantikan" },
  { id: 12, name: "Mengunjungi Pameran bersama UFO/ CUFO", category: "Pameran", points: 5, description: "Kunjungan pameran bersama anggota" },
  { id: 13, name: "Memenangkan Lomba Fotografi/Videografi di UGM", category: "Prestasi", points: 5, description: "Juara lomba foto/video internal UGM" },
  { id: 14, name: "Piket Sekre Akbar", category: "Sekre", points: 5, description: "Piket sekretariat akbar" },
  { id: 15, name: "Piket Sekre", category: "Sekre", points: 5, description: "Piket rutin sekretariat" },
  { id: 16, name: "Submit Penugasan Diklat", category: "Diklat", points: 5, description: "Pengumpulan penugasan diklat" },
  { id: 17, name: "UFOlunteer", category: "Event", points: 5, description: "Menjadi volunteer dalam kegiatan UFO" },
  { id: 18, name: "Ikut Presentasi Karya Pameris (Pra-pel)", category: "Review", points: 3, description: "Presentasi karya pameris pra-pelantikan" },
  { id: 19, name: "Menjadi Divisi DDD di kepanitiaan", category: "Organisasi", points: 3, description: "Kontribusi sebagai divisi DDD dalam kepanitiaan" },
  { id: 20, name: "Mengikuti Workshop/Seminar Fotografi/Videografi (selain UFO)", category: "Diklat", points: 3, description: "Workshop/seminar eksternal" },
  { id: 21, name: "Hunting Individu", category: "Hunting", points: 2, description: "Kegiatan hunting foto secara individu" },
  { id: 22, name: "Kurasi Pameran", category: "Pameran", points: 2, description: "Proses kurasi karya pameran" },
  { id: 23, name: "Mengikuti Lomba Fotografi/Videografi", category: "Prestasi", points: 2, description: "Partisipasi lomba foto/video" },
  { id: 24, name: "Membantu Dokumentasi UKM / Komunitas di UGM", category: "Dokumentasi", points: 2, description: "Dokumentasi untuk UKM atau komunitas UGM" },
  { id: 25, name: "First Gathering CUFO", category: "Event", points: 1, description: "Kehadiran pada first gathering CUFO" },
  { id: 26, name: "Main ke Sekre UFO (min. 2 jam)", category: "Sekre", points: 1, description: "Kunjungan ke sekretariat minimal 2 jam" },
  { id: 27, name: "Mengunjungi Pameran Mandiri", category: "Pameran", points: 1, description: "Kunjungan pameran secara individu" },
  { id: 28, name: "Mengikuti One Week Challenge (poin dihitung perhari)", category: "Challenge", points: 1, description: "Poin dihitung per hari" },
  { id: 29, name: "Kegiatan lain Sesuai Kebijakan/Persetujuan Ketua UFO", category: "Lain-lain", points: 0, description: "Sesuai kebijakan/persetujuan Ketua UFO" },
];
