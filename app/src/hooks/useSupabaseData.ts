...
const ACTIVITY_TYPES: DbActivityType[] = [
  { id: 1, number: 1, name: "Diksar", points: 15, requires_role: "no" },
  { id: 2, number: 2, name: "Pameris Pameran Prapel", points: 10, requires_role: "no" },
  { id: 3, number: 3, name: "Panitia Pameran Prapel", points: 10, requires_role: "yes" },
  { id: 4, number: 4, name: "Memenangkan Lomba Fotografi/Videografi di luar UGM (S&K Berlaku)", points: 8, requires_role: "no" },
  { id: 5, number: 5, name: "Memenangkan Lomba Fotografi/Videografi Internasional", points: 40, requires_role: "no" },
  { id: 6, number: 6, name: "Memenangkan Lomba Fotografi/Videografi Nasional", points: 25, requires_role: "no" },
  { id: 7, number: 7, name: "Diklat Wajib & Umum", points: 8, requires_role: "no" },
  { id: 8, number: 8, name: "Event Hunting UFO", points: 8, requires_role: "no" },
  { id: 9, number: 9, name: "Kunjungan Pameran FOSERA", points: 8, requires_role: "no" },
  { id: 10, number: 10, name: "Berpartisipasi Dalam Kegiatan HUT UFO", points: 5, requires_role: "no" },
  { id: 11, number: 11, name: "Hunting Bareng UFO/CUFO di luar Event Hunting (Min. 3 Orang)", points: 5, requires_role: "no" },
  { id: 12, number: 12, name: "Ketua Kelompok Pameran Pra Pelantikan", points: 5, requires_role: "yes" },
  { id: 13, number: 13, name: "Mengunjungi Pameran bersama UFO/CUFO", points: 5, requires_role: "no" },
  { id: 14, number: 14, name: "Memenangkan Lomba Fotografi/Videografi di UGM", points: 5, requires_role: "no" },
  { id: 15, number: 15, name: "Piket Sekre Akbar", points: 8, requires_role: "no" },
  { id: 16, number: 16, name: "Piket Sekre", points: 5, requires_role: "no" },
  { id: 17, number: 17, name: "Berpartisipasi Photo of The Month / Stock Photo", points: 3, requires_role: "no" },
  { id: 18, number: 18, name: "Submit Penugasan Diklat", points: 5, requires_role: "no" },
  { id: 19, number: 19, name: "UFOlunteer", points: 5, requires_role: "no" },
  { id: 20, number: 20, name: "Ikut Presentasi Karya Pameris (Pra-pel)", points: 3, requires_role: "no" },
  { id: 21, number: 21, name: "Menjadi Divisi DDD di kepanitiaan", points: 3, requires_role: "yes" },
  { id: 22, number: 22, name: "Mengikuti Workshop/Seminar Fotografi/Videografi (selain UFO)", points: 3, requires_role: "no" },
  { id: 23, number: 23, name: "Hunting Individu", points: 2, requires_role: "no" },
  { id: 24, number: 24, name: "Kurasi Pameran", points: 2, requires_role: "no" },
  { id: 25, number: 25, name: "Mengikuti Lomba Fotografi/Videografi", points: 2, requires_role: "no" },
  { id: 26, number: 26, name: "Membantu Dokumentasi UKM / Komunitas di UGM", points: 2, requires_role: "no" },
  { id: 27, number: 27, name: "First Gathering CUFO", points: 1, requires_role: "no" },
  { id: 28, number: 28, name: "Main ke Sekre UFO (min. 2 jam)", points: 1, requires_role: "no" },
  { id: 29, number: 29, name: "Mengunjungi Pameran Mandiri", points: 1, requires_role: "no" },
  { id: 30, number: 30, name: "Kegiatan lain Sesuai Kebijakan/Persetujuan Ketua UFO", points: 0, requires_role: "no" },
];
